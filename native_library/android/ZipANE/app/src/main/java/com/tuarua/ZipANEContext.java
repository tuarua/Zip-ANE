...
public class ZipANEContext extends FreKotlinContext implements TRActivityResultCallback, TRStateChangeCallback {
    private AndroidActivityWrapper aaw;
    private FreKotlinMainController controller;

    @SuppressWarnings("WeakerAccess")
    public ZipANEContext(String name, FreKotlinMainController controller, String[] functions) {
