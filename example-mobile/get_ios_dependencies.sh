...
wget https://github.com/tuarua/Zip-ANE/releases/download/0.0.1/ios_dependencies.zip
unzip -u -o ios_dependencies.zip
rm ios_dependencies.zip

wget -O ../native_extension/ane/ZipANE.ane https://github.com/tuarua/Zip-ANE/releases/download/0.0.1/ZipANE.ane?raw=true
